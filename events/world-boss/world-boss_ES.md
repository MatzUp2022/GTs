# Jefe Mundial — Escuadrón de evento (Last Light)
...
- **5 golpes por día.**
- **3 golpes** otorgan además **recompensas especiales** → nunca dejarlos caducar.
- **Solo cuenta el golpe con el daño más alto** para la puntuación.
- → No repetir 5 veces la misma formación. Cada intento sin variación es información desperdiciada.

## 3. Secuencia recomendada

| Golpe | Objetivo | Formación |
|-------|----------|-----------|
| 1 | Referencia | Mejor formación conocida, con el tipo bonificado |
| 2 | Variante A | Un héroe cambiado (reforzar el tipo bonificado) |
| 3 | Variante B | Variación de habilidades / equipo frente a la referencia |
| 4 | Consolidación | La mejor de los golpes 1–3, con corrección fina |
| 5 | Golpe máximo | Todos los buffs y potenciadores en la formación ganadora |
