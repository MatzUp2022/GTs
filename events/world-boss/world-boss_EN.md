# World Boss — Event Squad (Last Light)
...
## 2. Hit Economy
- **5 hits per day.**
- **3 hits** additionally grant **special rewards** → never let them expire.
- **Only the single highest-damage hit counts** for scoring.
- → Do not run the same setup 5 times. Every unvaried run wastes information.

## 3. Recommended Sequence

| Hit | Purpose | Setup |
|-----|---------|-------|
| 1 | Baseline | Best known lineup, bonus type included |
| 2 | Variant A | Swap one hero (reinforce the bonus type) |
| 3 | Variant B | Skill / gear variation against the baseline |
| 4 | Consolidation | Best of hits 1–3 with a fine correction |
| 5 | Max run | All buffs and boosters on the winning lineup |
